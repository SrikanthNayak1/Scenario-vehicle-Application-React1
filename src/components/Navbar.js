  ...
  return (
    <>
      <div className="topnav" id="myTopnav" ref={ref}>
        ...
        <Link id='addscenario' onClick={handleClick} className={`${activePage === 'addscenario' && 'active'}`} to="/addscenario">Add Scenario</Link>
        <Link id='allscenarios' onClick={handleClick} className={`${activePage === 'allscenarios' && 'active'}`} to="/allscenarios">All Scenarios</Link>
        <Link id='addvehiclesform' onClick={handleClick} className={`${activePage === 'addvehiclesform' && 'active'}`} to="/addvehiclesform">Add Vehicle</Link>
