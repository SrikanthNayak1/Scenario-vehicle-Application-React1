...
function AddVehiclesForm() {
  ...
  console.log(scenarios[0]);
    ...
    const onSubmit = (data) => {
      ...
      // Add new vehicle to vehicles endpoint
      axios
        .post(`${appUrl}/vehicles`, {
          id: vehicleId,
          name: data.vehicleName,
        ...
        .then(() => {
          ...
          axios
            .get(`${appUrl}/scenarios/${data.scenarioId}`)
            .then((response) => {
              let scenario = response.data;
    
              // Add new vehicle to the scenario's vehicles list
              ...
              axios
                .put(`${appUrl}/scenarios/${data.scenarioId}`, scenario)
                .then(() => {
                  toast.success("Added Successfully", {
                    position: toast.POSITION.TOP_CENTER,
                    autoClose: 1000,
